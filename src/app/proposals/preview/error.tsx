    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="max-w-md w-full p-6">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Unable to Load Proposal Preview</h2>
        </div>
        <div className="space-y-4">
          <p className="text-gray-600 text-center">
            We're having trouble loading the proposal preview. This might be due to a network issue
            or the proposal may no longer exist.
          </p>
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>• Return to the proposal list to select another proposal</li>
            </ul>
          </div>
