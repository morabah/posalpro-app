              ...
              <div className="px-6 py-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-md p-4">
                    ...
                    {errorType === 'component' && (
                      <p className="text-sm text-gray-600">
                        Attempts to access a property on null. This will trigger a React rendering
                        error.
                      </p>
                    )}
                    {errorType === 'api' && (
                  ...
                  <div className="bg-blue-50 rounded-md p-4">
                    ...
                    <p className="text-sm text-blue-700">
                      When you click the button, you should see the error boundary UI with options
                      to "Try Again" or "Go to Dashboard". Check the browser console for detailed
                      error logging.
                    </p>
                  </div>
                </div>
