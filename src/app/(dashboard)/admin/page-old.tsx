...
const RoleManager = dynamic(() => import('@/features/admin/components/RoleManager'), {
  loading: () => (
...
const DatabaseSyncPanel = dynamic(() => import('@/features/admin/components/DatabaseSyncPanel'), {
  loading: () => (
