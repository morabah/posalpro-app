    ...
    <main aria-labelledby="page-title" className="space-y-6 p-6">
      <div className="sticky top-0 z-10 -mx-6 px-6 py-3 backdrop-blur bg-white/70 dark:bg-gray-900/70 border-b border-gray-200 dark:border-gray-800">
        <div className="flex items-center justify-between">
          <h1 id="page-title" className="text-2xl font-bold text-gray-900 dark:text-gray-100">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 gap-6 lg:flex lg:flex-row">
        ...
        >
          <details open className="group rounded-lg bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800">
            <summary
            ...
            >
              <span id="recent-heading" className="text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Proposals</span>
        ...
        >
          ...
          >
            ...
            >
              <span id="quick-actions-heading" className="text-lg font-semibold text-gray-900 dark:text-gray-100">Quick Actions</span>
