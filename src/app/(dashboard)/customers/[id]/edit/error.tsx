    ...
    <div className="container mx-auto p-6">
      <Card className="max-w-2xl mx-auto p-6">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Unable to Load Customer Editor</h2>
        </div>
        <div className="space-y-4">
          <p className="text-gray-600 text-center">
            We're having trouble loading the customer information for editing. This might be due to
            issues fetching customer data or form setup problems.
          </p>
