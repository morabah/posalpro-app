    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="max-w-md w-full p-6">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Unable to Load Customer Profile</h2>
        </div>
        <div className="space-y-4">
          <p className="text-gray-600 text-center">
            We're having trouble loading the customer profile information. This might be due to the
            customer not existing or a network issue.
          </p>

          <div className="bg-gray-50 p-3 rounded-lg">
            <p className="text-sm text-gray-500 mb-2">What you can try:</p>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Check if the customer ID is correct</li>
