/**
 * PosalPro MVP2 - Countries Data Source
 * ISO 3166-1 alpha-2 country codes for standardized country selection
 * User Story: US-2.1 (Customer Management - Country Field Enhancement)
 * Hypothesis: H3 (Customer relationship management improves proposal success)
 *
 * ✅ STANDARDIZED: ISO country codes for data consistency
 * ✅ ACCESSIBLE: Full country names with flag emojis
 * ✅ PERFORMANT: Optimized for dropdown rendering
 * ✅ VALIDATED: Against standard country lists
 */
...
export const countryUtils = {
  ...
  /**
   * Get sorted countries list (alphabetically by name)
   */
  ...
  /**
   * Get countries for popular regions (optimization for large lists)
   */
