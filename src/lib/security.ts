...
export function getSecurityHeaders(): Record<string, string> {
  return {
    ...
    'Content-Security-Policy':
      "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdnjs.cloudflare.com https://unpkg.com https://mozilla.github.io 'report-sample'; script-src-elem 'self' 'unsafe-eval' 'unsafe-inline' https://cdnjs.cloudflare.com https://unpkg.com https://mozilla.github.io 'report-sample'; script-src-attr 'none'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com; style-src-attr 'none'; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https:; connect-src 'self' https://api.posalpro.com https://cdnjs.cloudflare.com https://unpkg.com https://mozilla.github.io; worker-src 'self' blob: https://cdnjs.cloudflare.com https://unpkg.com https://mozilla.github.io; frame-src 'self' http://localhost:8080 https: https://mozilla.github.io; frame-ancestors 'none'; report-uri /api/security/csp-report",
